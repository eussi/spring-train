...
public class LocaleSample {
	...
	public static void resourceBoundle(){
		ResourceBundle rb1 = ResourceBundle.getBundle("com/eussi/i18n/resource",Locale.US);
		ResourceBundle rb2 = ResourceBundle.getBundle("com/eussi/i18n/resource",Locale.CANADA);
	...
	public static void resourceBoundleFmt(){
		ResourceBundle rb1 = ResourceBundle.getBundle("com/eussi/i18n/fmt_resource",Locale.US);
		ResourceBundle rb2 = ResourceBundle.getBundle("com/eussi/i18n/fmt_resource",Locale.CHINA);

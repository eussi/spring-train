package com.eussi.spel;

import com.eussi.User;
...
public class ObjectExprSample {
    public static void main(String[] args) {
        ...
        System.out.println(user.getUserName());//anyli
         ...
         user = parser.parseExpression("new com.eussi.User('tom')").getValue(User.class);
        ...
        Class userClass=parser.parseExpression("T(com.eussi.User)").getValue(Class.class);
        System.out.println(dateClass== Date.class);
        System.out.println(stringClass== String.class);
        System.out.println(userClass == com.eussi.User.class);
